...
def imprimirRegistradores(a, t, s, ra, pc):
 ...
 |{"Registradores":^68}|
 ----------------------------------------------------------------------
 | $s0: {s[0]:<7}| $t0: {t[0]:<7}| $a0: {a[0]:<7}| $pc: {pc[0]:<7}| $ra: {ra[0]:<7}|
 | $s1: {s[1]:<7}| $t1: {t[1]:<7}| $a1: {a[1]:<7}|      {"":<7}|       {"":<6}|
 | $s2: {s[2]:<7}| $t2: {t[2]:<7}| $a2: {a[2]:<7}|      {"":<7}|       {"":<6}|
 | $s3: {s[3]:<7}|       {"":<6}|       {"":<6}|       {"":<6}|       {"":<6}|
 | $s4: {s[4]:<7}|       {"":<6}|       {"":<6}|       {"":<6}|       {"":<6}|
 ----------------------------------------------------------------------
    ''')
...
if __name__ == '__main__':
    ...
    while True:
        try:
            #print(f'\n {"Arquivo" :-^58}')
            arquivo = str(input(' Insira o nome do arquivo de entrada: '))
